...
/**
 * Bean information for VisualGraphProperties.
 * @author Dieter J Kybelksties
 */
public class VisualGraphPropertiesBeanInfo extends SimpleBeanInfo
{

    private static final Class CLAZZ = VisualGraphPropertiesBeanInfo.class;
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( VisualGraphProperties.class , VisualGraphPropertiesEditor.class ); // NOI18N//GEN-HEADEREND:BeanDescriptor
