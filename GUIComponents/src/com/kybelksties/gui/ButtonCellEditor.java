...
/**
 * The ButtonCellEditor class provides a renderer and an editor that looks like
 * a JButton. The renderer and editor will then be used for a specified column
...
//		renderButton.setText( (value == null) ? "" : value.toString() );
    ...
    @Override //  Implement ActionListener interface
    ...
    @Override //  Implement MouseListener interface
