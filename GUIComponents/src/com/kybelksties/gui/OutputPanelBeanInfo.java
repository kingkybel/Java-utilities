...
public class OutputPanelBeanInfo
extends SimpleBeanInfo
{
    
    private static final Class CLAZZ = OutputPanelBeanInfo.class;
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( com.kybelksties.gui.OutputPanel.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_defaultBackground = 22;
    private static final int PROPERTY_defaultBold = 23;
    private static final int PROPERTY_defaultFontFamily = 24;
    private static final int PROPERTY_defaultFontSize = 25;
    private static final int PROPERTY_defaultForeground = 26;
    private static final int PROPERTY_defaultItalic = 27;
    ...
    private static final int PROPERTY_styledDocument = 91;
    ...
    private static final int PROPERTY_verbose = 101;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", com.kybelksties.gui.OutputPanel.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", com.kybelksties.gui.OutputPanel.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", com.kybelksties.gui.OutputPanel.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", com.kybelksties.gui.OutputPanel.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", com.kybelksties.gui.OutputPanel.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", com.kybelksties.gui.OutputPanel.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", com.kybelksties.gui.OutputPanel.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", com.kybelksties.gui.OutputPanel.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", com.kybelksties.gui.OutputPanel.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", com.kybelksties.gui.OutputPanel.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", com.kybelksties.gui.OutputPanel.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", com.kybelksties.gui.OutputPanel.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", com.kybelksties.gui.OutputPanel.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", com.kybelksties.gui.OutputPanel.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", com.kybelksties.gui.OutputPanel.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", com.kybelksties.gui.OutputPanel.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", com.kybelksties.gui.OutputPanel.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", com.kybelksties.gui.OutputPanel.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", com.kybelksties.gui.OutputPanel.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", com.kybelksties.gui.OutputPanel.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", com.kybelksties.gui.OutputPanel.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", com.kybelksties.gui.OutputPanel.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions].setPreferred ( true );
            properties[PROPERTY_defaultBackground] = new PropertyDescriptor ( "defaultBackground", com.kybelksties.gui.OutputPanel.class, "getDefaultBackground", "setDefaultBackground" ); // NOI18N
            properties[PROPERTY_defaultBackground].setPreferred ( true );
            properties[PROPERTY_defaultBold] = new PropertyDescriptor ( "defaultBold", com.kybelksties.gui.OutputPanel.class, "isDefaultBold", "setDefaultBold" ); // NOI18N
            properties[PROPERTY_defaultBold].setPreferred ( true );
            properties[PROPERTY_defaultFontFamily] = new PropertyDescriptor ( "defaultFontFamily", com.kybelksties.gui.OutputPanel.class, "getDefaultFontFamily", "setDefaultFontFamily" ); // NOI18N
            properties[PROPERTY_defaultFontFamily].setPreferred ( true );
            properties[PROPERTY_defaultFontSize] = new PropertyDescriptor ( "defaultFontSize", com.kybelksties.gui.OutputPanel.class, "getDefaultFontSize", "setDefaultFontSize" ); // NOI18N
            properties[PROPERTY_defaultFontSize].setPreferred ( true );
            properties[PROPERTY_defaultForeground] = new PropertyDescriptor ( "defaultForeground", com.kybelksties.gui.OutputPanel.class, "getDefaultForeground", "setDefaultForeground" ); // NOI18N
            properties[PROPERTY_defaultForeground].setPreferred ( true );
            properties[PROPERTY_defaultItalic] = new PropertyDescriptor ( "defaultItalic", com.kybelksties.gui.OutputPanel.class, "isDefaultItalic", "setDefaultItalic" ); // NOI18N
            properties[PROPERTY_defaultItalic].setPreferred ( true );
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", com.kybelksties.gui.OutputPanel.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", com.kybelksties.gui.OutputPanel.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", com.kybelksties.gui.OutputPanel.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", com.kybelksties.gui.OutputPanel.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", com.kybelksties.gui.OutputPanel.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", com.kybelksties.gui.OutputPanel.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", com.kybelksties.gui.OutputPanel.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", com.kybelksties.gui.OutputPanel.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", com.kybelksties.gui.OutputPanel.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", com.kybelksties.gui.OutputPanel.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", com.kybelksties.gui.OutputPanel.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", com.kybelksties.gui.OutputPanel.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", com.kybelksties.gui.OutputPanel.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", com.kybelksties.gui.OutputPanel.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", com.kybelksties.gui.OutputPanel.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", com.kybelksties.gui.OutputPanel.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", com.kybelksties.gui.OutputPanel.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", com.kybelksties.gui.OutputPanel.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", com.kybelksties.gui.OutputPanel.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", com.kybelksties.gui.OutputPanel.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", com.kybelksties.gui.OutputPanel.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", com.kybelksties.gui.OutputPanel.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", com.kybelksties.gui.OutputPanel.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", com.kybelksties.gui.OutputPanel.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", com.kybelksties.gui.OutputPanel.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", com.kybelksties.gui.OutputPanel.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", com.kybelksties.gui.OutputPanel.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", com.kybelksties.gui.OutputPanel.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", com.kybelksties.gui.OutputPanel.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", com.kybelksties.gui.OutputPanel.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", com.kybelksties.gui.OutputPanel.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", com.kybelksties.gui.OutputPanel.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", com.kybelksties.gui.OutputPanel.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", com.kybelksties.gui.OutputPanel.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", com.kybelksties.gui.OutputPanel.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", com.kybelksties.gui.OutputPanel.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", com.kybelksties.gui.OutputPanel.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", com.kybelksties.gui.OutputPanel.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", com.kybelksties.gui.OutputPanel.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", com.kybelksties.gui.OutputPanel.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", com.kybelksties.gui.OutputPanel.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", com.kybelksties.gui.OutputPanel.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", com.kybelksties.gui.OutputPanel.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", com.kybelksties.gui.OutputPanel.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", com.kybelksties.gui.OutputPanel.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", com.kybelksties.gui.OutputPanel.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", com.kybelksties.gui.OutputPanel.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", com.kybelksties.gui.OutputPanel.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", com.kybelksties.gui.OutputPanel.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", com.kybelksties.gui.OutputPanel.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", com.kybelksties.gui.OutputPanel.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", com.kybelksties.gui.OutputPanel.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", com.kybelksties.gui.OutputPanel.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", com.kybelksties.gui.OutputPanel.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", com.kybelksties.gui.OutputPanel.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", com.kybelksties.gui.OutputPanel.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", com.kybelksties.gui.OutputPanel.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", com.kybelksties.gui.OutputPanel.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", com.kybelksties.gui.OutputPanel.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", com.kybelksties.gui.OutputPanel.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", com.kybelksties.gui.OutputPanel.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", com.kybelksties.gui.OutputPanel.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", com.kybelksties.gui.OutputPanel.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_styledDocument] = new PropertyDescriptor ( "styledDocument", com.kybelksties.gui.OutputPanel.class, "getStyledDocument", null ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", com.kybelksties.gui.OutputPanel.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", com.kybelksties.gui.OutputPanel.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", com.kybelksties.gui.OutputPanel.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", com.kybelksties.gui.OutputPanel.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", com.kybelksties.gui.OutputPanel.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", com.kybelksties.gui.OutputPanel.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", com.kybelksties.gui.OutputPanel.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", com.kybelksties.gui.OutputPanel.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", com.kybelksties.gui.OutputPanel.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verbose] = new PropertyDescriptor ( "verbose", com.kybelksties.gui.OutputPanel.class, "isVerbose", "setVerbose" ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", com.kybelksties.gui.OutputPanel.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", com.kybelksties.gui.OutputPanel.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", com.kybelksties.gui.OutputPanel.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", com.kybelksties.gui.OutputPanel.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", com.kybelksties.gui.OutputPanel.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", com.kybelksties.gui.OutputPanel.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", com.kybelksties.gui.OutputPanel.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( com.kybelksties.gui.OutputPanel.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( com.kybelksties.gui.OutputPanel.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( com.kybelksties.gui.OutputPanel.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( com.kybelksties.gui.OutputPanel.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( com.kybelksties.gui.OutputPanel.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( com.kybelksties.gui.OutputPanel.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( com.kybelksties.gui.OutputPanel.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( com.kybelksties.gui.OutputPanel.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( com.kybelksties.gui.OutputPanel.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( com.kybelksties.gui.OutputPanel.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( com.kybelksties.gui.OutputPanel.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( com.kybelksties.gui.OutputPanel.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( com.kybelksties.gui.OutputPanel.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_addStyle9 = 9;
    ...
    private static final int METHOD_reset123 = 123;
    private static final int METHOD_reset124 = 124;
    private static final int METHOD_reset125 = 125;
    ...
    private static final int METHOD_write147 = 147;
    private static final int METHOD_write148 = 148;
    private static final int METHOD_write149 = 149;
    private static final int METHOD_writeHighlight150 = 150;
    private static final int METHOD_writeln151 = 151;
    private static final int METHOD_writeln152 = 152;
    private static final int METHOD_writeln153 = 153;
    private static final int METHOD_writelnError154 = 154;
    private static final int METHOD_writelnHighlight155 = 155;
    private static final int METHOD_writelnMeta156 = 156;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_addStyle9] = new MethodDescriptor(com.kybelksties.gui.OutputPanel.class.getMethod("addStyle", new Class[] {java.lang.Comparable.class, java.awt.Color.class, java.awt.Color.class, java.lang.String.class, java.lang.Integer.class, java.lang.Boolean.class, java.lang.Boolean.class})); // NOI18N
            methods[METHOD_addStyle9].setDisplayName ( "" );
            ...
            methods[METHOD_reset123] = new MethodDescriptor(com.kybelksties.gui.OutputPanel.class.getMethod("reset", new Class[] {})); // NOI18N
            methods[METHOD_reset123].setDisplayName ( "" );
            methods[METHOD_reset124] = new MethodDescriptor(com.kybelksties.gui.OutputPanel.class.getMethod("reset", new Class[] {java.lang.String.class})); // NOI18N
            methods[METHOD_reset124].setDisplayName ( "" );
            methods[METHOD_reset125] = new MethodDescriptor(com.kybelksties.gui.OutputPanel.class.getMethod("reset", new Class[] {java.lang.String.class, java.lang.Integer.class})); // NOI18N
            methods[METHOD_reset125].setDisplayName ( "" );
            ...
            methods[METHOD_write147] = new MethodDescriptor(com.kybelksties.gui.OutputPanel.class.getMethod("write", new Class[] {javax.swing.text.Style.class, java.lang.String.class})); // NOI18N
            methods[METHOD_write147].setDisplayName ( "" );
            methods[METHOD_write148] = new MethodDescriptor(com.kybelksties.gui.OutputPanel.class.getMethod("write", new Class[] {java.lang.Comparable.class, java.lang.String.class})); // NOI18N
            methods[METHOD_write148].setDisplayName ( "" );
            methods[METHOD_write149] = new MethodDescriptor(com.kybelksties.gui.OutputPanel.class.getMethod("write", new Class[] {java.lang.String.class})); // NOI18N
            methods[METHOD_write149].setDisplayName ( "" );
            methods[METHOD_writeHighlight150] = new MethodDescriptor(com.kybelksties.gui.OutputPanel.class.getMethod("writeHighlight", new Class[] {java.lang.String.class})); // NOI18N
            methods[METHOD_writeHighlight150].setDisplayName ( "" );
            methods[METHOD_writeln151] = new MethodDescriptor(com.kybelksties.gui.OutputPanel.class.getMethod("writeln", new Class[] {javax.swing.text.Style.class, java.lang.String.class})); // NOI18N
            methods[METHOD_writeln151].setDisplayName ( "" );
            methods[METHOD_writeln152] = new MethodDescriptor(com.kybelksties.gui.OutputPanel.class.getMethod("writeln", new Class[] {java.lang.Comparable.class, java.lang.String.class})); // NOI18N
            methods[METHOD_writeln152].setDisplayName ( "" );
            methods[METHOD_writeln153] = new MethodDescriptor(com.kybelksties.gui.OutputPanel.class.getMethod("writeln", new Class[] {java.lang.String.class})); // NOI18N
            methods[METHOD_writeln153].setDisplayName ( "" );
            methods[METHOD_writelnError154] = new MethodDescriptor(com.kybelksties.gui.OutputPanel.class.getMethod("writelnError", new Class[] {java.lang.String.class})); // NOI18N
            methods[METHOD_writelnError154].setDisplayName ( "" );
            methods[METHOD_writelnHighlight155] = new MethodDescriptor(com.kybelksties.gui.OutputPanel.class.getMethod("writelnHighlight", new Class[] {java.lang.String.class})); // NOI18N
            methods[METHOD_writelnHighlight155].setDisplayName ( "" );
            methods[METHOD_writelnMeta156] = new MethodDescriptor(com.kybelksties.gui.OutputPanel.class.getMethod("writelnMeta", new Class[] {java.lang.String.class})); // NOI18N
            methods[METHOD_writelnMeta156].setDisplayName ( "" );
        }
