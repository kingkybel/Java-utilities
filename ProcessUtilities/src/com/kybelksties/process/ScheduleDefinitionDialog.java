...
public class ScheduleDefinitionDialog extends javax.swing.JDialog
{
    ...
    static ConnectionInfoList serverConfigs = initializeConnectionList(
                              "");

    static ConnectionInfoList initializeConnectionList(String filename)
    {
        serverConfigs = new ConnectionInfoList();
        serverConfigs.add("lonlx1056b14", 9898, "Linux1");
        serverConfigs.add("lonux20029", 9898, "UNIX1");
        serverConfigs.add("lonlx1071b11", 9898, "Linux2");
                                     ...
                                     ScheduledProcess scheduledProcess)
    {
        ...
        newBackColor = scheduledProcess.getWindowBackground();
        if (newBackColor == null)
        {
            newBackColor = Color.BLACK;
        }

        newForeColor = scheduledProcess.getWindowForeground();
    ...
    private void initComponents()
    {
        ...
        targetComboBox.setModel(serverConfigs.getComboBoxModel());
    ...
    {//GEN-HEADEREND:event_changeColorButtonActionPerformed
        ...
        theScheduledProcess.setWindowBackground(newBackColor);
        theScheduledProcess.setWindowForeground(newForeColor);
