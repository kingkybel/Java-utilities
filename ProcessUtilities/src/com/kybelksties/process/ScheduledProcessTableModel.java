                   ...
                   ConcreteProcess.StateEventListener
{
    ...
    private static final String[] theColumnNames =
    {
        NbBundle.getMessage(CLAZZ,
                            "ScheduledProcessTableModel.columnHeader.state"),
        // NbBundle.getMessage(CLAZZ,
        //                    "ScheduledProcessTableModel.columnHeader.procType"),
        NbBundle.getMessage(CLAZZ,
                            "ScheduledProcessTableModel.columnHeader.executable"),
        NbBundle.getMessage(CLAZZ,
                            "ScheduledProcessTableModel.columnHeader.windowMode"),
        NbBundle.getMessage(CLAZZ,
                            "ScheduledProcessTableModel.columnHeader.startDir"),
        NbBundle.getMessage(CLAZZ,
                            "ScheduledProcessTableModel.columnHeader.parameters"),
        NbBundle.getMessage(CLAZZ,
                            "ScheduledProcessTableModel.columnHeader.logFile"),
        NbBundle.getMessage(CLAZZ,
                            "ScheduledProcessTableModel.columnHeader.sleep"),//,
    // NbBundle.getMessage(CLAZZ,
    //                    "ScheduledProcessTableModel.columnHeader.backGround"),
    // NbBundle.getMessage(CLAZZ,
    //                    "ScheduledProcessTableModel.columnHeader.foreGround"),
    };
